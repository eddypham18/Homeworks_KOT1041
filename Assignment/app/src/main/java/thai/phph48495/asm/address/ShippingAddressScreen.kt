...
fun ShippingAddressScreen(
    ...
    val isLoading by addressViewModel.isLoading.observeAsState(initial = false)
...
fun CardShippingAddress(
    ...
    // Đảm bảo trạng thái isDefault luôn được cập nhật từ model
    // không dùng remember để tránh trạng thái cũ được lưu lại
        ...
        Row(
            ...
            Checkbox(
                ...
                onCheckedChange = { isChecked ->
                    // Chỉ kích hoạt callback khi chọn (true), không bỏ chọn
                    if (isChecked) {
